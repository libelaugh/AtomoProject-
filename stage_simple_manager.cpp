...
void StageSimpleManager_Initialize(const StageInfo& info)
{
	...
	Camera_Initialize({ 0.004f,4.8f,-8.7f }, { 0.0f, -0.5f, 0.85f }, { 0.0f,0.85f,0.53f }, { 1.0f,0.0f,0.0f });
...
void StageSimpleManager_Update(float elapsedTime)
{
